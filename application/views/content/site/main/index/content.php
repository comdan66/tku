...
<?php
  if ($c) { ?>
    ...
    <?php foreach ($pics = CamPic::find ('all', array ('limit' => 60, 'order' => 'id DESC', 'conditions' => array ('cam_id = ?', $c->id))) as $pic) { ?>
    ...
    <?php } ?>
      ...
      <figcaption>
        ...
        <time><?php echo $pics[0]->created_at->format ('Y-m-d H:i:s');?><time>
      </figcaption>
    </figure>
<?php
  } else { ?>
